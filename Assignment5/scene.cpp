...
void Scene::Up() {
	...
	fb->Clear(0xFFFFFFFF, 0.0f);
	mesh->RenderFilled(ppc, fb, texture, 0xFF0000FF, L, 0, 0, renderM, lookupM, tilingM);
...
void Scene::SM1() {
	...
	renderM = 1;
	tmeshes[1]->RenderFilled(ppc, fb, texture, 0xFF0000FF, L, 0, 0, renderM, lookupM, tilingM);
	fb->redraw();
}
...
void Scene::SM2() {
	...
	renderM = 2;
	tmeshes[1]->RenderFilled(ppc, fb, texture, 0xFF0000FF, L, ka, es, renderM, lookupM, tilingM);
	fb->redraw();
}
...
void Scene::SM2Play() {
	...
	for (int i = 0; i < step; i++){
		...
		renderM = 2;
		tmeshes[1]->RenderFilled(ppc, fb, texture, 0xFF0000FF, L, 0.5, 900, renderM, lookupM, tilingM);
