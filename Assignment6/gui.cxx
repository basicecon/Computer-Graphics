...
void GUI::cb_Neighbor_i(Fl_Button*, void*) {
	neighbor_cb();
}
void GUI::cb_Neighbor(Fl_Button* o, void* v) {
	((GUI*)(o->parent()->user_data()))->cb_Neighbor_i(o, v);
}
...
GUI::GUI() {
  { uiw = new Fl_Double_Window(870, 796, "Control Center");
	...
	{ Fl_Input* o = new Fl_Input(255, 375, 55, 35);
      o->callback((Fl_Callback*)cb_pointlightY);
    } // Fl_Input* pointlightY
	{ Fl_Input* o = new Fl_Input(308, 375, 60, 35);
      o->callback((Fl_Callback*)cb_pointlightZ);
    } // Fl_Input* pointlightZ
	{ Fl_Input* o = new Fl_Input(135, 435, 95, 30, "Ambient factor: ");
      o->callback((Fl_Callback*)cb_ka);
    } // Fl_Input* ka
	{ Fl_Input* o = new Fl_Input(162, 470, 68, 30, "Specular exponent: ");
      o->callback((Fl_Callback*)cb_es);
    } // Fl_Input* es
	{ Fl_Button* o = new Fl_Button(35, 524, 55, 25, "SM1");
      o->callback((Fl_Callback*)cb_SM1);
    } // Fl_Button* SM1
	{ Fl_Button* o = new Fl_Button(90, 524, 55, 25, "SM2");
      o->callback((Fl_Callback*)cb_SM2);
    } // Fl_Button* SM2
	{ Fl_Button* o = new Fl_Button(145, 524, 55, 25, "SM3");
      o->callback((Fl_Callback*)cb_SM3);
    } // Fl_Button* SM3
	{ Fl_Button* o = new Fl_Button(305, 435, 125, 35, "SM2 Moving Light");
      o->callback((Fl_Callback*)cb_SM2Play);
    } // Fl_Button* SM2Play
	{ Fl_Button* o = new Fl_Button(305, 478, 125, 35, "SM3 Moving Light");
      o->callback((Fl_Callback*)cb_SM3Play);
    } // Fl_Button* SM3Play
	{ Bilinear = new Fl_Button(305, 60, 80, 30, "Bilinear");
	Bilinear->callback((Fl_Callback*)cb_Bilinear);
	} // Fl_Button* Bilinear
	{ Neighbor = new Fl_Button(305, 90, 80, 30, "Neighbor");
	Neighbor->callback((Fl_Callback*)cb_Neighbor);
	} // Fl_Button* Neighbor
	{ Repetition = new Fl_Button(305, 120, 80, 30, "Repeat");
	Repetition->callback((Fl_Callback*)cb_Repetition);
	} // Fl_Button* Repetition
	{ Mirroring = new Fl_Button(305, 150, 80, 30, "Mirror");
	Mirroring->callback((Fl_Callback*)cb_Mirroring);
	} // Fl_Button* Mirroring
	{ Shadow = new Fl_Button(305, 300, 80, 30, "Shadow");
	Shadow->callback((Fl_Callback*)cb_Shadow);
	} // Fl_Button* Mirroring
	{ Load = new Fl_Button(150, 120, 80, 30, "Load");
...
void GUI::pointlightX_cb() {
  scene->GetPointLightX();
}

void GUI::pointlightY_cb() {
  scene->GetPointLightY();
}

void GUI::pointlightZ_cb() {
  scene->GetPointLightZ();
}
